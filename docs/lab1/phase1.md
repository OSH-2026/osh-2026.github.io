...
在 [kernel.org](https://www.kernel.org/) 上可以下载到 Linux 内核的源代码。此次实验，我们选择最新的 **稳定版**，Linux 6.19.10 的内核进行编译。
...
| **「可选」**对 linux 内核进行交叉编译 (推荐 ARM64 或者 [RISC-V 64](riscv64-kernel.md)) 并用对应版本 qemu 运行，将过程记录在`lab1/README.md` 中 | 10%  |
