...
- **Cursor（推荐主力）**
  ...
  - Rules（团队/课程共享规则）：`https://cursor.com/docs/context/rules`
...
但这类框架也会放大安全风险，因此课程侧要设置安全默认值（详见 `standards.md`）。
...
- **Android（AOSP）**
  ...
  - 文档入口：`https://source.android.com/docs`
  - Setup：`https://source.android.com/docs/setup`
