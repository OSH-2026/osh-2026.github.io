...
- 2026-03-26：GitHub 提示：_自 4 月 24 日起，除非您选择退出，否则我们将开始使用 GitHub Copilot 交互数据进行 AI 模型训练。请查阅此更新，并在您的 GitHub 账户设置中管理您的偏好设置。_ 请注意由此可能带来的数据安全问题。
...
|      实验       |  发布时间  |  截止时间  |
| :-------------: | :--------: | :--------: |
| [实验零](lab0/) | 2026-03-16 | 2026-03-30 (已经截止) |
| [实验一](lab1/) | 2026-03-28 | 2026-04-13 (已经截止) |
| [实验二](lab2/) | 2026-04-20 | 2026-05-04 (已经截止) |
| [实验三](lab3/) | 2026-05-11 | 2026-05-25|
| [实验四](lab4/) | 2026-05-25 | 2026-06-08|
...
| 实验四 |  初探大模型推理系统  |                        大模型部署与推理、分布式系统  |    无      |
